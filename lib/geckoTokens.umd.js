...
const { HEX } = __webpack_require__(4914)
...
const { normalizeIPv6, normalizeIPv4, removeDotSegments, recomposeAuthority, normalizeComponentEncoding } = __webpack_require__(4834)
const SCHEMES = __webpack_require__(343)
...
const getTokenList_ajv = new (ajv_default())({ allErrors: true, verbose: true });
dist_default()(getTokenList_ajv);
const tokenListValidator = getTokenList_ajv.compile(tokenlist_schema);
